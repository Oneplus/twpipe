...
public:
  ...
  static inline uint8_t compact_category(char32_t chr);
...
uint8_t unicode::compact_category(char32_t chr) {
  return chr < CHARS ? category_block[category_index[chr >> 8]][chr & 0xFF] : _Cn;
}
